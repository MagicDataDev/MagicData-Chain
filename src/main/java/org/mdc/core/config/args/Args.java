package org.mdc.core.config.args;
...
import org.mdc.core.db.backup.DbBackupConfig;
import org.mdc.keystore.CipherException;
import org.mdc.keystore.Credentials;
import org.mdc.keystore.WalletUtils;
import org.mdc.program.Version;
...
public class Args {
  ...
  @Parameter(names = {
      "--contract-parse-enable"}, description = "enable contract parses in java-mdc or not.(true or false)")
  ...
  //If you are running a solidity node for java mdc, this flag is set to true
  @Getter
  @Setter
