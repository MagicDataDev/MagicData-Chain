...
import org.mdc.core.exception.BalanceInsufficientException;
...
import org.mdc.protos.Contract.AssetIssueContract.FrozenSupply;
import org.mdc.protos.Protocol.Account.Frozen;
...
//      assetIssueCapsule.setOrder(order);
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (dbManager.getDynamicPropertiesStore().getAllowSameTokenName() != 0) {
      ...
      if (name.equals("mdc")) {
        throw new ContractValidateException("assetName can't be mdc");
      }
    }
    ...
    if (assetIssueContract.getMdcNum() <= 0) {
      throw new ContractValidateException("MdcNum must greater than 0!");
    }
