...
import org.mdc.protos.Contract.ParticipateAssetIssueContract;
...
public class ParticipateAssetIssueActuator extends AbstractActuator {
  ...
  public boolean execute(TransactionResultCapsule ret) throws ContractExeException {
    ...
    try {
      ...
      exchangeAmount = Math.floorDiv(exchangeAmount, assetIssueCapsule.getMdcNum());
...
//    }
    ...
    try {
      ...
      int trxNum = assetIssueCapsule.getMdcNum();
