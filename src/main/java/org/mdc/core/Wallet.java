...
import org.mdc.api.GrpcAPI.TransactionExtention.Builder;
import org.mdc.api.GrpcAPI.TransactionSignWeight.Result;
...
import org.mdc.common.runtime.Runtime;
import org.mdc.common.runtime.RuntimeImpl;
...
import org.mdc.common.storage.DepositImpl;
import org.mdc.common.utils.*;
import org.mdc.core.actuator.Actuator;
import org.mdc.core.actuator.ActuatorFactory;
import org.mdc.core.capsule.*;
...
import org.mdc.protos.Contract.TriggerSmartContract;
import org.mdc.protos.Protocol;
import org.mdc.protos.Protocol.*;
import org.mdc.protos.Protocol.Permission.PermissionType;
import org.mdc.protos.Protocol.SmartContract.ABI;
import org.mdc.protos.Protocol.SmartContract.ABI.Entry.StateMutabilityType;
import org.mdc.protos.Protocol.Transaction.Contract;
...
import static org.mdc.core.config.Parameter.DatabaseConstants.EXCHANGE_COUNT_LIMIT_MAX;
import static org.mdc.core.config.Parameter.DatabaseConstants.PROPOSAL_COUNT_LIMIT_MAX;
...
public class Wallet {
  ...
  public NodeList listNodes() {
    ...
    nodeHandlerMap.entrySet().stream()
        .forEach(v -> {
          org.mdc.common.overlay.discover.node.Node node = v.getValue().getNode();
