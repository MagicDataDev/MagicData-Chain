...
import org.mdc.api.DatabaseGrpc.DatabaseImplBase;
import org.mdc.api.GrpcAPI;
import org.mdc.api.GrpcAPI.*;
import org.mdc.api.GrpcAPI.Return.response_code;
import org.mdc.api.WalletExtensionGrpc;
import org.mdc.api.WalletGrpc.WalletImplBase;
import org.mdc.api.WalletSolidityGrpc.WalletSolidityImplBase;
...
import org.mdc.core.exception.NonUniqueObjectException;
import org.mdc.core.exception.StoreException;
...
public class RpcApiService implements Service {
  ...
  public class DatabaseApi extends DatabaseImplBase {
    ...
    @Override
    public void getBlockReference(org.mdc.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.mdc.api.GrpcAPI.BlockReference> responseObserver) {
  ...
  public class WalletSolidityApi extends WalletSolidityImplBase {
    ...
    public void getDelegatedResourceAccountIndex(BytesMessage request,
        StreamObserver<org.mdc.protos.Protocol.DelegatedResourceAccountIndex> responseObserver) {
      responseObserver
  ...
  public class WalletApi extends WalletImplBase {
    ...
    private void checkVoteWitnessAccount(VoteWitnessContract req) {
      ...
      Preconditions.checkArgument(account.getMPower(dbManager) < votesCount,
          "mdc power[" + account.getMPower(dbManager) + "] <  VotesCount[" + votesCount + "]");
...
//    }
    ...
    @Override
    public void deployContract(org.mdc.protos.Contract.CreateSmartContract request,
