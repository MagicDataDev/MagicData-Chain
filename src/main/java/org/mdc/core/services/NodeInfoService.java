...
import org.mdc.common.entity.NodeInfo.ConfigNodeInfo;
import org.mdc.common.entity.NodeInfo.MachineInfo;
import org.mdc.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import org.mdc.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
import org.mdc.common.entity.PeerInfo;
...
import org.mdc.core.services.WitnessProductBlockService.CheatWitnessInfo;
  ...
  private void setConnectInfo(NodeInfo nodeInfo) {
    ...
    for (PeerConnection peerConnection : syncPool.getActivePeers()) {
      ...
      ReasonCode reasonCode = peerConnection.getNodeStatistics()
          .getMdcLastLocalDisconnectReason();
      peerInfo.setLocalDisconnectReason(reasonCode == null ? "" : reasonCode.toString());
      reasonCode = peerConnection.getNodeStatistics().getMdcLastRemoteDisconnectReason();
