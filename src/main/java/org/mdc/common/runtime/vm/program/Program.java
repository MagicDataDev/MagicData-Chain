...
package org.mdc.common.runtime.vm.program;
...
import org.mdc.common.runtime.config.VMConfig;
import org.mdc.common.runtime.vm.*;
import org.mdc.common.runtime.vm.program.invoke.ProgramInvoke;
import org.mdc.common.runtime.vm.program.invoke.ProgramInvokeFactory;
import org.mdc.common.runtime.vm.program.invoke.ProgramInvokeFactoryImpl;
import org.mdc.common.runtime.vm.program.listener.CompositeProgramListener;
import org.mdc.common.runtime.vm.program.listener.ProgramListenerAware;
import org.mdc.common.runtime.vm.program.listener.ProgramStorageChangeListener;
import org.mdc.common.runtime.vm.trace.ProgramTrace;
import org.mdc.common.runtime.vm.trace.ProgramTraceListener;
import org.mdc.common.storage.Deposit;
import org.mdc.common.utils.ByteUtil;
import org.mdc.common.utils.FastByteComparisons;
import org.mdc.common.utils.Utils;
import org.mdc.core.Wallet;
import org.mdc.core.actuator.TransferActuator;
import org.mdc.core.actuator.TransferAssetActuator;
...
import org.mdc.protos.Protocol.SmartContract.Builder;
...
import static org.mdc.common.runtime.utils.MUtil.*;
import static org.mdc.common.utils.BIUtil.isPositive;
import static org.mdc.common.utils.BIUtil.toBI;
import static org.mdc.common.utils.ByteUtil.stripLeadingZeroes;
...
public class Program {
   ...
   * @param value the mdc value transferred in the internaltransaction
   */
      ...
      try {
        ...
        if (VMConfig.allowTvmConstantinople()) {
          throw new TransferException(
              "transfer all token or transfer all mdc failed in suicide: %s", e.getMessage());
        }
    ...
    if (byTestingSuite()) {
      ...
      if (!isTokenTransfer) {
        try {
          ...
          if (VMConfig.allowTvmConstantinople()) {
            refundEnergy(msg.getEnergy().longValue(), "refund energy from message call");
            throw new TransferException("transfer mdc failed: %s", e.getMessage());
          }
          throw new BytecodeExecutionException(VALIDATE_FOR_SMART_CONTRACT_FAILURE, e.getMessage());
        }
        deposit.addBalance(senderAddress, -endowment);
